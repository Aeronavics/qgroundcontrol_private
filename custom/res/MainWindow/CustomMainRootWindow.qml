/****************************************************************************
 *
 * 2009-2016 QGROUNDCONTROL PROJECT <http://www.qgroundcontrol.org>
 *
...
//import QGroundControl.CustomFlightDisplayView 1.0
...
ApplicationWindow {
    ...
    Drawer {
        ...
        onOpened: {
            dlgLoader.source = "/qml/QGCViewDialogContainer.qml"
        }
        onClosed: {
            dlgLoader.source = ""
        }
